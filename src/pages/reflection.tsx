  ...
  return (
    <Layout>
      ...
      <AnimatedBox style={pageAnimation} py={[6, 6, 6, 8]} px={[6, 6, 8, 6, 8, 13]}>
        ...
        <p>Climate mitigation was a core concept that we studied during our trip. As our professor said many times, mitigation is avoiding the unmanageable. Mitigation means changing our everyday behaviors in such a way that we can have less of an impact on climate change. This can mean a lot of things, but primarily it means reducing our reliance on fossil fuels. When we think about climate change mitigation, the amount of fossil fuels we consumed on our trip begs to be questioned. </p>
        ...
        <p>I think that one of the strongest impressions that this trip has imprinted upon me is that the impact of my lifestyle is affecting others more than it is affecting me. This is a fact, and it is a fact that I knew before I left for this trip. But it wasn&#39;t until this trip that I had to actually confront this fact. I had look at the landscapes that my habits are destroying, look into the eyes of the people that my conviences are inconviencing. One of the most disturbing aspects of this trip is how little it shocked me beforehand. Before we left, I had not questioned the amount of travelling we were undertaking. I had accepted it as normal.</p>
